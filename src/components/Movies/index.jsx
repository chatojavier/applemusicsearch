import { SearchInputMovies } from "../SearchInput";
...
const Movies = () => {
	...
	const [{ isLoading, isError, data }, doFetch] = useDataApi(
		`https://itunes.apple.com/search?media=movie&entity=${selectedOption}&term=${query
			.split(" ")
			.join("+")
    ...
    return (
        <div className='h-full flex flex-col md:flex-row'>
            <SearchInputMovies
                ...
                className='px-4 pb-2 border-b md:border-b-0 md:border-r border-solid border-gray-700 bg-gray sticky top-0 z-50 md:w-52'></SearchInputMovies>
